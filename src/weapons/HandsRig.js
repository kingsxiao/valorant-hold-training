...
export const GLOVE_POSES = {
  ...
  vandal: {
    handR: {
      ...
      fDes: [-0.3, -0.88, -0.36],
      sDes: [0.2, 0.8, -0.55],
      curls: { pinky: [30, [115, -20, 0], [110, 0, 15], 18], ring: [30, [115, -20, 0], 110, 20], middle: [28, [100, -15, 10], 115, 22], index: [0, 60, 60, 20], thumb: [-25, 15, 5, 5] },
    },
    handL: {
      wrist: [-1.35, 0.38, 0.0],
      fDes: [-0.2, -0.1, -0.97],
  ...
  phantom: {
    handR: {
      ...
      fDes: [-0.3, -0.88, -0.36],
      sDes: [0.2, 0.8, -0.55],
      curls: { pinky: [30, 115, 110, 18], ring: [30, 120, 115, 20], middle: [28, 115, 115, 22], index: [0, 55, 55, 18], thumb: [-45, [15, 0, 20], 5, 5] },
    },
    handL: {
      ...
      fDes: [-0.2, -0.1, -0.97],
      sDes: [0.95, 0.25, -0.2],
      curls: { pinky: [42, 92, 95, 20], ring: [40, 88, 95, 26], middle: [38, 103, 120, 22], index: [36, 80, 115, 35], thumb: [[10, 40, 40], [2, 0, 0], -14, 0] },
    },
  },
}
