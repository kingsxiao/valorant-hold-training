...
只有一种纯粹的架枪对枪训练：开局 3 秒倒计时（GO 后才开始计时），随机延迟后 Bot 以全速从巷道缺口拉出——带概率急停与"露头即缩"的 jiggle-peek（拉到中段折返缩回，逼你守住准星等第二拉）；在"击杀时限"内没打中，Bot 就缩回墙后、记一次对枪败，你继续架下一波——**没有死亡/掉血设定**，训练节奏永不中断，练先开枪能力。墙上只开一个缺口，出生点就在缺口正前方的架枪位，进局即对口架枪；中场木箱可换点位架枪，地面距离标线帮助测距。
